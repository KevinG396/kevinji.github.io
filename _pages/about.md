...
Inference-time controlled sampling and posterior inference for probabilistic generative models (Diffusion, Flow Matching, Consistency Models, Flow Maps), variational inference, distribution shift.
...
## **Generative Modeling**
Probabilistic generative models and their applications in active discovery/decision making.
...
Accelerating AI computation (Neural Networks and Graph structures).
