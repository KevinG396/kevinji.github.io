...
# Research:
My research interests lie in **Machine Learning** (Diffusion Model) and **Parallel Computing** (AI Inference Acceleration), as well as the intersection of these two areas.
